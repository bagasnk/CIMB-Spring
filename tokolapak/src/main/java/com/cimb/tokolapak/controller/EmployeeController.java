...
public class EmployeeController {
	...
	@PutMapping("/{id}")
	public Optional<Employee> addEmployeeAddress(@PathVariable int id, @RequestBody EmployeeAddress employeeAddress){
		return employeeService.addEmployeeAddress(id,employeeAddress);
	}
